...
import com.example.flink.project.beans.AdClickEvent;
import com.example.flink.project.beans.AdCountViewByProvince;
import com.example.flink.project.beans.BlackListUserWarning;
...
/**
 * 广告点击量统计（通过省份区分），并添加黑名单管理
 */
public class AdStatisticByProvinceWIthBlacklist {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 1. 从文件中读取数据
        URL resource = AdStatisticByProvinceWIthBlacklist.class.getResource("/AdClickLog.csv");
